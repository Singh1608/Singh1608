...
//      Transformation", "Technology Strategy") counts as tech.
...
const RULES = [
  ...
  ["tech", /\b(ai|digital|technology|tech|it|data) (transformation|strategy)\b/i],
  ...
  ["finance", /\b(finance|financial(?! (services|crime|institutions?))|cfo|fp&a|controlling|controller|accounting|accountant|product control|valuations?|treasury|tax|audit)\b/i],
  ["strategy", /(\bstrateg(y|ic|ist)|strategy&)/i],
  ["transformation", /\b(transformation|operating model|tom|organi[sz]ational design|org design|change management|operations|operational|process (improvement|excellence)|lean|six sigma|reorgani[sz]ation)\b/i],
  ["tech", /\b(data|analytics|ai|artificial intelligence|machine learning|ml|technology|digital|it|erp|sap|workday|oracle|salesforce|eloqua|cloud|iam|cyber|security|engineer|developer|architect|hadoop|gcp|aws|azure|automation)\b/i],
